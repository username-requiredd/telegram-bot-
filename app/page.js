...
import { ScanLine, Bell, Dot, DollarSign, Upload, Download, ArrowLeftRight, X } from 'lucide-react';
...
<div className="min-h-screen flex flex-col px-4 mb-5 ">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-white px-4 py-8 md:px-8 md:py-12 lg:px-12 lg:py-16">
        ...
        <h3 className="font-bold text-4xl mb-2 md:text-5xl lg:text-6xl">$29393272</h3>
        <p className="text-lg font-medium text-green-600 mb-8 md:text-xl lg:text-2xl">+4.5%</p>
