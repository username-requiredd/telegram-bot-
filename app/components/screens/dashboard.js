...
const Dashboard = ({ changeUistate }) => {
  ...
  const QuickActionButton = ({ icon: Icon, label, onClick, color, bgColor }) => (
    <button
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {isOpen && (
          <div className="relative z-50 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-3xl p-8 mb-12 overflow-hidden shadow-2xl border-2 border-white/10 animate-slide-in">
            ...
            <div className="absolute -top-10 -right-10 w-40 h-40 bg-white bg-opacity-5 rounded-full animate-blob"></div>
            <div className="absolute -bottom-10 -left-10 w-56 h-56 bg-white bg-opacity-5 rounded-full animate-blob animation-delay-2000"></div>
          </div>
        )}
